export default {
    ...
    fields: [
        ...
        // Preview Fields for Cards
        {
            ...
            rows: 2,
            description:
                "The short hook used on the homepage/portfolio grid cards.",
        },
        {
            name: "featuredMetric",
            ...
            type: "text",
            description:
                "Optional: A high-impact stat to highlight on the card.",
        },
                    ...
                    fields: [
                        {
                            ...
                            title: "Outcome Label",
                            type: "string",
                            description: "e.g., Code Maintainability",
                        },
                        {
                            name: "description",
                            title: "Description",
            ...
            fields: [
                {
                    name: "title",
                    type: "string",
                    initialValue: "Facing Similar Challenges?",
                },
                {
                    name: "description",
                    type: "text",
                    initialValue: "Every modernization journey is unique...",
                },
                {
                    name: "buttonText",
                    type: "string",
