...
export default defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            type: "string",
            description:
                "The Lucide icon name (e.g., Database, GitBranch, Shield)",
        }),
        defineField({
        ...
        defineField({
            ...
            rows: 3,
            description:
                "The high-level narrative for the top of the detail page.",
        }),
        ...
        defineField({
            ...
            description:
                "The long-form explanation of your unique approach to this service.",
            type: "text",
            rows: 6,
        }),
        ...
        defineField({
            ...
            description:
                'Direct pain points this service solves (e.g., "Architectural Debt").',
            type: "array",
            of: [{ type: "string" }],
        }),
        ...
        defineField({
            ...
            description:
                "Link specific portfolio pieces that prove your expertise in this service.",
            type: "array",
            of: [
                {
                    type: "reference",
        ...
        defineField({
            ...
            type: "object",
            description:
                "Optional: Customize the closure of this service page.",
            fields: [
                {
                    name: "title",
                    type: "string",
                ...
                },
                {
                    ...
                    rows: 3,
                    initialValue:
                        "Every system evolves. Let's discuss how to transition yours toward a stable, modern future.",
                },
                {
                    name: "buttonText",
                    type: "string",
