...
export default function ContactPage() {
  ...
  >
    ...
    <div>
      ...
      <p className="text-sm text-foreground/60 mb-0">hello@graycoastweb.com</p>
    </div>
  </a>
  ...
  >
    ...
    <div>
      ...
      <p className="text-sm text-foreground/60 mb-0">Connect professionally</p>
    </div>
  </a>
  ...
  >
    ...
    <div>
      ...
      <p className="text-sm text-foreground/60 mb-0">View open source contributions</p>
    </div>
  </a>
</div>
          </section>
        ...
        <div className="p-16 text-center rounded-sm border transition-all duration-500 bg-primary/5 text-foreground border-primary/10"
              >
                ...
                <p className="text-foreground/60 mb-6 max-w-xl mx-auto font-light mb-6">
